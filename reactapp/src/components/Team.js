                                ...
                                teamMember["main"] ? 
                                    <div className="featured d-inline-block mx-4">
                                        ...
                                        <div className="social-links-feat">
                                            <span className="social-icon mx-2"><a href={teamMember["facebook"]}><FontAwesomeIcon icon={faLinkedin} /></a></span>
                                            <span className="social-icon mx-2"><a href={teamMember["linkedin"]}><FontAwesomeIcon icon={faFacebook} /></a></span>
                                        </div>
                                    </div> : ""
