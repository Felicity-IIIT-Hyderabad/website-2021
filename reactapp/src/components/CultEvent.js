...
const CultEvent = () => {
    ...
    const changeDay = async (dayNum) => {
      await setSelectedDay("Day"+dayNum)
    }
    ...
    return (
        <div>
            ...
            <div className="font-weight-bold infopage-title my-5 event-heading text-white"> CULTURAL </div>
            ...
            <div className="my-5">
                ...
                {culturalEvents[selectedDay].map(event => (
